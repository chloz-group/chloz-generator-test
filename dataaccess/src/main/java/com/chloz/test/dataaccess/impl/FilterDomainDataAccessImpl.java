 ...
 */
public class FilterDomainDataAccessImpl<T, I, F extends SimpleFilter>
		extends
			FilterDomainDataAccessBaseImplBase<T, I, F>
		implements
			FilterDomainDataAccess<T, I, F> {

	protected FilterDomainDataAccessImpl(DefaultDomainRepository<T, I> repository, QueryBuilder<F, ?> queryBuilder) {
