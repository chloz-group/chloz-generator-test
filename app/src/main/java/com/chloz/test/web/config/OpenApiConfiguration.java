...
public class OpenApiConfiguration {
	...
	public OpenAPI springOpenAPI() {
		...
		return new OpenAPI()
				.info(new Info().title("Chloz test API").description("Chloz test application API").version("v1.0.0")
						.license(new License().name("Apache 2.0").url("http://www.chloztest.com")))
